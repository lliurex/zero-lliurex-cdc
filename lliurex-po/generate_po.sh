...
xgettext --join-existing -kde -ki18nd:2 ../lliurex-cdc-control.install/ui/rsrc/Loading.qml -o ../lliurex-po/lliurex-cdc-control/lliurex-cdc-control.pot
xgettext --join-existing -kde -ki18nd:2 ../lliurex-cdc-control.install/ui/rsrc/ChangesDialog.qml -o ../lliurex-po/lliurex-cdc-control/lliurex-cdc-control.pot
